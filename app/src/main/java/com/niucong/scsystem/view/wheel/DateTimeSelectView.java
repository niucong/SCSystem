...
public class DateTimeSelectView extends LinearLayout {
    ...
    private void initData(final Context context) {
        ...
        LinearLayout.LayoutParams layoutParamss = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, 1);
        layoutParamss.gravity = Gravity.CENTER;
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, 2);
        layoutParams.gravity = Gravity.CENTER;
        LinearLayout.LayoutParams layoutParam = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, 4);
        layoutParam.bottomMargin = 5;
        layoutParam.gravity = Gravity.CENTER;
        addView(wvYear, layoutParamss);
        addView(tv, layoutParam);
        addView(wvMonth, layoutParams);
        addView(tv1, layoutParam);
        addView(wvDay, layoutParams);
        addView(tv2, layoutParam);
        addView(wvHour, layoutParams);
        addView(tv3, layoutParam);
